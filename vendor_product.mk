...
ifneq ($(filter bengal kona seraph lahaina taro anorak neo blair kalama pineapple sun canoe parrot monaco trinket tuna kera crow pitti niobe volcano anorak61 neo61,$(TARGET_BOARD_PLATFORM)),)
...
ifeq ($(USB_USES_QMAA),true)
  ...
  #
  ifneq ($(filter bengal kona seraph niobe taro anorak neo kalama pineapple sun canoe parrot blair monaco trinket crow pitti volcano anorak61 neo61,$(TARGET_BOARD_PLATFORM)),)
