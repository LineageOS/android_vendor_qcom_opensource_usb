...
ifneq ($(filter bengal lahaina taro parrot neo anorak blair kalama pineapple monaco kona crow trinket pitti niobe volcano anorak61,$(TARGET_BOARD_PLATFORM)),)
...
ifeq ($(USB_USES_QMAA),true)
  ...
  #
  ifneq ($(filter bengal niobe taro kalama neo parrot anorak pineapple blair monaco kona crow trinket qcs605 pitti volcano anorak61,$(TARGET_BOARD_PLATFORM)),)
